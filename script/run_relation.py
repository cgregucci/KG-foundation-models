...
from kgfm import tasks as _kgfm_tasks  # for build_relation_adj
...
if __name__ == "__main__":
    ...
    # TRIX models read `data.relation_adj`; MOTIF's pre_transform doesn't build it.
    for d in (train_data, valid_data, test_data):
        if not hasattr(d, "relation_adj") or d.relation_adj is None:
            _kgfm_tasks.build_relation_adj(d)
